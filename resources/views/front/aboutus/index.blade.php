...
@section('body')
    ...
    <section class="pt-120 pb-120 position-relative">
        <div class="feature-car">
            <img src="{{asset('/')}}fronts/assets/images/elements/feature-car.png" alt="image">
        </div>
        <div class="container">
                ...
                <div class="col-xl-9">
                    <div class="row mb-none-30">
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/5.png" alt="image"></div>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/6.png" alt="image"></div>
                                </div>
                                <div class="feature-card__content">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/7.png" alt="image"></div>
                                </div>
                                <div class="feature-card__content">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/8.png" alt="image"></div>
                                </div>
                                <div class="feature-card__content">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/9.png" alt="image"></div>
                                </div>
                                <div class="feature-card__content">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-30">
                            <div class="feature-card style--two">
                                <div class="feature-card__icon">
                                    <div class="inner"><img src="{{asset('/')}}fronts/assets/images/icon/feature/10.png" alt="image"></div>
                                </div>
                                <div class="feature-card__content">
        ...
        <div class="container">
            ...
            <div class="row mb-none-30 justify-content-center">
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-card">
                        <div class="team-card__thumb">
                            <img src="{{asset('/')}}fronts/assets/images/team/1.png" alt="image">
                            <div class="obj"><img src="{{asset('/')}}fronts/assets/images/elements/team-obj.png" alt="image"></div>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-card">
                        <div class="team-card__thumb">
                            <img src="{{asset('/')}}fronts/assets/images/team/2.png" alt="image">
                            <div class="obj"><img src="{{asset('/')}}fronts/assets/images/elements/team-obj.png" alt="image"></div>
                        </div>
                        <div class="team-card__content">
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-card">
                        <div class="team-card__thumb">
                            <img src="{{asset('/')}}fronts/assets/images/team/3.png" alt="image">
                            <div class="obj"><img src="{{asset('/')}}fronts/assets/images/elements/team-obj.png" alt="image"></div>
                        </div>
                        <div class="team-card__content">
